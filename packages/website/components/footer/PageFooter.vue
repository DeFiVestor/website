...
const copyright = computed<string>(() => `© DeFiVestor Solutions GmbH 2018-${year}.`);
</script>
...
<template>
  <div>
    <div class="container">
      ...
      <div
        class="flex flex-col-reverse lg:flex-row justify-between items-start md:items-center pt-8 pb-12"
      >
        <div
